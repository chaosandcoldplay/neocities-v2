    ...
    var b = {
        init: function (b) {
            function e(a) {
                var b = a.pageX,
                    c = a.pageY;
                d.style_my_tooltips("position", { smtCursorCoordsX: b, smtCursorCoordsY: c });
            }
            var c = { tip_follows_cursor: !1, tip_delay_time: 700, tip_fade_speed: 300, attribute: "title" },
                b = a.extend(c, b);
        ...
        update: function (b) {
            ...
            c
                ...
                (smtTooltip_delay = setTimeout(function () {
                    c.style_my_tooltips("show", { speed: b.speed, tip_follows_cursor: b.tip_follows_cursor });
                }, b.delay));
        },
        show: function (b) {
            var c = a(this);
